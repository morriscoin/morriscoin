...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // MorrisCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "MorrisCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    int64 nSubsidy = 730000 * COIN;
 
    nSubsidy >>= (nHeight / 73000); // Subsidy is halved every 100k blockscalc
     
    if(nHeight == 1)
    {
        nSubsidy = 1501501501 * COIN;
    }
    else if(nHeight < 731)
    {
        nSubsidy = 1 * COIN;
    }
    else if(nHeight%730 == 0)
    {
        nSubsidy = 7300000;
    }
...
static const int64 nTargetTimespan = 730 * 73; // MorrisCoin: every 730 blocks 
static const int64 nTargetSpacing = 73 ; // MorrisCoin: 73 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // MorrisCoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal morriscoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MorrisCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa9a5deee07a7e34fbee6b344faabee6b8f659912c4f5fed1ade3e7fee4a19784");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "73 is the Truck Morris of numbers!!!!!111!1!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1389618180;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1985331;


        if (fTestNet)
        {
            block.nTime    = 1389403121;
            block.nNonce   = 1554248;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8863f440727094eb9c01a06bec5b33aa935935bd589d91a1ab13fe9a55969710"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // MorrisCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
