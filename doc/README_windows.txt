...
Setup
-----
Unpack the files into a directory and run morriscoin-qt.exe.

If you have Microsoft Security Essentials, you need to add morriscoin-qt.exe to its
"Excluded processes" list.  Microsoft Security Essentials->Settings tab,
select Excluded processes, press Add, select morriscoin-qt.exe, OK, Save changes.
